<%-- 
    Document   : cart.jsp
    Created on : Apr 23, 2022, 10:53:50 PM
    Author     : User
--%>
                                        ...
                                        <c:forEach items="${sessionScope.carts}" var="c">
                                            ...
                                            <tr>
                                                <td class="product-thumbnail">
                                                    <img src="images/${c.value.book.image}" alt="Image" class="img-fluid">
                                                </td>
                                                <td class="product-name">
                                                    <h2 class="h5 text-black">${c.value.book.name}</h2>
                                                </td>
                                                ...
                                                <td>
                                                    <form action="cart?id=${c.value.book.id}" method="post"> 
                                                        <input type="hidden" nam="id" value="${c.value.book.id}"/>
